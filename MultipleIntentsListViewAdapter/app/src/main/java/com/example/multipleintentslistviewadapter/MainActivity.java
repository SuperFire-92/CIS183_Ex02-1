...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        registeredUsers[1] = "Bob Smithagin";
        registeredUsers[2] = "Bob Smithanigan";
        fillListView();
        ...
        //catch the info the was passed back to me by register
    ...
    public void fillListView()
    {
        ...
        //Changing any details of any specific cell will require it's own xml file.
